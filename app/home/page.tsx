...
export default function HomePage() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-start gap-6 p-8 bg-black">
      ...
      {/* Dashboard Cards */}
      <section className="grid w-full max_w-6xl grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      {/* Footer */}
      <footer className="w-full max_w-6xl flex justify-center items-center py-8">
        <a
